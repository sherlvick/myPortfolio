    ...
    return (
        <div className={classes.PageContainer}>
            ...
            <div className={classes.ContactDetailWrapper}>
                <img className={classes.ContactImg} src={contactBanner} width="256px" height="256px" />
                <div className={classes.ContactInfo}>
                    <Map /><a href="https://goo.gl/maps/sQ1B1CdFRLUfSZ856" target="_blank">Paramount Raghavendra, Victorian Meadows Rd, Silver Springs Layout, Munnekollal, Bengaluru, Karnataka 560037</a>
                </div>
                <div className={classes.ContactInfo}>
